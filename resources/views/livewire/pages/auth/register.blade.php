...
<div
    ...
    <div class="relative w-full max-w-[500px] h-[90vh] md:h-auto md:max-h-[90vh] flex flex-col">
        ...
        <div class="text-center mb-6 animate-fade-in-down shrink-0">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-600 shadow-xl shadow-indigo-500/30 mb-4 transform transition hover:scale-105 duration-300">
            ...
            <h2 class="text-2xl font-black text-slate-800 tracking-tight">Daftar <span class="text-indigo-600">Merchant</span></h2>
            <p class="text-slate-500 text-xs font-medium mt-1 tracking-wide">Mulai kelola restoranmu dengan LaraCarte</p>
        </div>

        <!-- Scrollable Form Container -->
        <div class="bg-white/90 backdrop-blur-xl border border-white/60 rounded-[2rem] shadow-2xl shadow-slate-200/50 flex-1 overflow-hidden flex flex-col relative">
            ...
            <div class="overflow-y-auto p-8 sm:p-10 no-scrollbar custom-scrollbar">
                <form wire:submit="register" class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1" for="name">
                            Nama Lengkap
                        </label>
                    ...
                    <!-- Store Name -->
                    <div class="flex flex-col gap-1.5">
                        <label class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1" for="store_name">
                            Nama Restoran / Toko
                        </label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <!-- Confirm Password -->
                        <div class="flex flex-col gap-1.5">
                            <label class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1" for="password_confirmation">
                                Konfirmasi
                            </label>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="w-full py-3.5 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/40 transform transition-all duration-300 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2 group">
                    ...
                    <div class="text-center">
                        <a class="text-xs font-bold text-slate-500 hover:text-indigo-600 transition-colors" href="{{ route('login') }}" wire:navigate>
